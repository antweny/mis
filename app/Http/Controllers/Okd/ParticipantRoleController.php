...
class ParticipantRoleController extends AuthController
{
     ...
     */
    public function __construct(ParticipantRoleService $participantRoleService)
    {
        parent::__construct();
    ...
    public function index()
    {
        try {
            ...
            return view('participant-roles.index',compact('participantRoles'));
        }
        catch (Exception $e) {
            return $this->error();
        }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('participant-roles.edit',compact('participantRole'));
        }
        catch (Exception $e) {
            return $this->error();
        }
