...
class StakeholderController extends AuthController
{
     ...
     */
    public function __construct(StakeholderService $stakeholder)
    {
        parent::__construct();
    ...
    public function index()
    {
        ...
        try {
            $stakeholders = $this->stakeholder->withRelation();  //Get all titles
    ...
    public function update(StakeholderRequest $request, $id)
    {
        ...
        try {
            ...
            return $this->successRoute('organization-stakeholders.index','Stakeholder updated');
        }
        catch (\Exception $e) {
            return $this->errorWithInput($request);
        }
