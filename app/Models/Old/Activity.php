...
class Activity extends BaseModel
{
    ...
    public function getCurrentYearActivity()
    {
        return $this->select('id','name','desc')->get();
    }

    public function getCurrentYearActivityIdNameDesc()
    {
        return $this->select('id','name','desc')->get();
    }

    //Get
    public function currentYearActivityDropdown()
    {
        return $this->select('id','name','desc')->orderBy('name','asc')->get();
    }
