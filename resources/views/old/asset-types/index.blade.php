                    ...
                    <td  class="text-center">
                        <div class="btn-group btn-group-sm">
                            @can('asset-type_update')
                                <a href="{{route('assetTypes.edit',$assetType)}}" class="btn mr-2 btn-edit" data-toggle="tooltip" data-placement="top" title="Edit item" >
                                    <i class="fa fa-edit"></i>
                                </a>
                            @endcan
                            @can('asset-type_delete')
                                <form method="POST" action="{{route('assetTypes.destroy',$assetType)}}" class="form-horizontal" role="form" autocomplete="off">
                                    @csrf
                                    @method('DELETE')
