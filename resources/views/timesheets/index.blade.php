        ...
        <x-modal id="new" title="New Timesheet" class="modal-xl">
            ...
            <x-form.post action="timesheets.store" >
                ...
                <div class="form-group">
                    <x-form.elements.label name="Date <span class='star'>*</span>" />
                ...
                <div class="row">
                    <div class="col-md-6 form-group ">
                        ...
                        <x-form.elements.input name="time_from" id="time_from" for="time_from" req="required" />
                    </div>
                    <div class="col-md-6 form-group ">
                        <x-form.elements.label name="Time To <span class='star'>*</span>" />
                        <x-form.elements.input name="time_to" id="time_to" for="time_to" req="required" />
                    </div>
                </div>
