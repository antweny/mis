                    ...
                    <td  class="text-center">
                        <div class="btn-group btn-group-sm">
                            @can('individual-group_update')
                                <a href="{{route('individualGroups.edit',$individualGroup)}}" class="btn mr-2 btn-edit" data-toggle="tooltip" data-placement="top" title="Edit item" >
                                    <i class="fa fa-edit"></i>
                                </a>
                            @endcan
                            @can('individual-group_delete')
                                <form method="POST" action="{{route('individualGroups.destroy',$individualGroup)}}" class="form-horizontal" role="form" autocomplete="off">
                                    @csrf
                                    @method('DELETE')
