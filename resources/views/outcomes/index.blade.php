                ...
                <tr>
                    ...
                    <td  class="text-center">
                        <div class="btn-group btn-group-sm">
                            @can('outcome_update')
                                <a href="{{route('outcomes.edit',$outcome)}}" class="btn btn-edit btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Edit" >
                                    <i class="fa fa-edit"></i>
                                </a>
                            @endcan
                            @can('outcome_delete')
                                <form method="POST" action="{{route('outcomes.destroy',$outcome)}}" class="form-horizontal" role="form" autocomplete="off">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-sm btn-delete mr-1" onclick="return confirm('Confirm to delete?')" data-toggle="tooltip" data-placement="top" title="Delete">
